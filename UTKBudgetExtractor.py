...
commandDict[f"SalaryAndBenefitsTotalYearOne"]          = ws[f"L63"].value
commandDict[f"SalaryAndBenefitsTotalYearTwo"]          = ws[f"M63"].value
commandDict[f"SalaryAndBenefitsTotalYearThree"]        = ws[f"N63"].value
commandDict[f"SalaryAndBenefitsTotalYearFour"]         = ws[f"O63"].value
commandDict[f"SalaryAndBenefitsTotalYearFive"]         = ws[f"P63"].value
...
commandDict[f"TravelTotalYearOne"]          = ws[f"L75"].value
commandDict[f"TravelTotalYearTwo"]          = ws[f"M75"].value
commandDict[f"TravelTotalYearThree"]        = ws[f"N75"].value
commandDict[f"TravelTotalYearFour"]         = ws[f"O75"].value
commandDict[f"TravelTotalYearFive"]         = ws[f"P75"].value
...
commandDict[f"OtherDirectTotalYearOne"]   = ws[f"L95"].value
commandDict[f"OtherDirectTotalYearTwo"]   = ws[f"M95"].value
commandDict[f"OtherDirectTotalYearThree"] = ws[f"N95"].value
commandDict[f"OtherDirectTotalYearFour"]  = ws[f"O95"].value
commandDict[f"OtherDirectTotalYearFive"]  = ws[f"P95"].value
...
commandDict[f"IndirectTotalYearOne"]            = ws[f"L102"].value
commandDict[f"IndirectTotalYearTwo"]            = ws[f"M102"].value
commandDict[f"IndirectTotalYearThree"]          = ws[f"N102"].value
commandDict[f"IndirectTotalYearFour"]           = ws[f"O102"].value
commandDict[f"IndirectTotalYearFive"]           = ws[f"P102"].value
commandDict[f"IndirectTotal"]                   = ws[f"Q102"].value

# Section K

commandDict[f"TotalYearOne"]            = ws[f"L103"].value
commandDict[f"TotalYearTwo"]            = ws[f"M103"].value
commandDict[f"TotalYearThree"]          = ws[f"N103"].value
commandDict[f"TotalYearFour"]           = ws[f"O103"].value
commandDict[f"TotalYearFive"]           = ws[f"P103"].value
commandDict[f"Total"]                   = ws[f"Q103"].value


with open(prefix+'BudgetDefs.tex', 'w') as outputFile:
...
print(">>>")
print(">>> Write output to "+prefix+"BudgetDefs.tex!")
